...
### For the Chrome version install it directly from the Chrome store [here](https://chromewebstore.google.com/detail/tube-audio-options+/nncagcdobheiaepocmngkbbilajgcblk).
